...
export default function Dashboard() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-[#F8FAFC]" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}> 
      ...
      {/* SOL MENYÜ (SIDEBAR) */}
      <aside className="sidebar" style={{ width: '250px', backgroundColor: '#FFFFFF', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '20px 16px', flexShrink: 0, borderRight: '1px solid #E2E8F0' }}>
        <div>
          {/* Logo Bölməsi */}
          <div className="logo-area" style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '30px', padding: '0 6px' }}>
            <div className="logo-icon" style={{ backgroundColor: '#44766C', color: '#FFFFFF', padding: '6px', borderRadius: '8px', display: 'flex', alignItems: 'center' }}>
              <Sprout size={20} />
            </div>
            <div className="logo-text">
              <h2 style={{ margin: 0, fontSize: '15px', fontWeight: '700', color: '#1E293B', letterSpacing: '0.5px' }}>E-MOTION</h2>
              <p style={{ margin: 0, fontSize: '11px', color: '#64748B' }}>Qarabağ Universiteti</p>
            </div>
          </div>
            ...
            {[
              ...
              <button 
                ...
                style={{
                  ...
                  textAlign: 'left',
                  transition: 'all 0.2s',
                  backgroundColor: activeTab === item.id ? '#44766C' : 'transparent',
...
>
  ...
  <span>Hesabdan Çıx</span>
      ...
      <div className="wrapper flex-1 flex flex-col" style={{ overflowY: 'auto', padding: '0' }}>
        ...
        {/* HEADER - Boşluqlar bir qədər də kiçidildi */}
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '9.5px 24px', backgroundColor: '#FFFFFF', borderBottom: '1px solid #E2E8F0', width: '100%' }}>
          ...
          <div className="header-right" style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            ...
            <div className="profile-card" style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer' }}>
              <div className="profile-img" style={{ width: '36px', height: '36px', borderRadius: '50%', backgroundColor: '#44766C', color: '#FFFFFF', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '600', fontSize: '14px' }}>Ə</div>
              <div className="profile-info" style={{ textAlign: 'left' }}>
                <h4 style={{ margin: 0, fontSize: '13.5px', fontWeight: '600', color: '#1E293B' }}>Əli Həsənov</h4>
                <p style={{ margin: 0, fontSize: '11px', color: '#64748B' }}>Kompüter Mühəndisliyi, 1-ci kurs</p>
              </div>
          ...
          {activeTab === 'dashboard' && (
            <div className="dashboard-layout" style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '20px' }}>
              ...
              <div className="left-content" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                {/* BANNER - Əvvəlki yaşıl qradient rənginə və standart dizaynına qaytarıldı */}
                <div style={{ background: 'linear-gradient(135deg, #2E5B4E, #193D33)', color: '#FFFFFF', padding: '24px 28px', borderRadius: '16px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ maxWidth: '68%' }}>
                      <h1 style={{ margin: 0, fontSize: '24px', fontWeight: '700' }}>Xoş gəlmisiniz, İstifadəçi!</h1>
